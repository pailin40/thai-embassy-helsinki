  ...
  const services = [
    {
      ...
      description:
        "New passport applications, renewals, and replacements for Thai citizens",
      details: [
    ...
    },
    {
      ...
      description:
        "Registration of births, marriages, and other civil status changes",
      details: [
        "Birth registration",
  ...
  const serviceGuideSteps = [
    {
      ...
      description:
        "Verify if you meet the requirements for the consular service",
      notes: [
    ...
    },
    {
      ...
      description:
        "Understand how and when you'll receive your processed documents",
      notes: [
  ...
  const faqItems = [
    {
      ...
      answer:
        "Document authentication typically takes 3-5 working days. Processing times may vary depending on the complexity of the documents and current workload.",
    },
    {
      question: "Can I submit documents by mail?",
      answer:
        "For security reasons, original documents must be submitted in person during your appointment. However, you can email copies for initial review.",
    },
    {
      question: "What payment methods do you accept?",
      answer:
        "We accept cash (Euros) and major credit/debit cards. Please note that fees must be paid at the time of service.",
    },
    {
      question: "Do I need an appointment for all services?",
      answer:
        "Appointments are required for passport services and civil registration. Document authentication is recommended by appointment but walk-ins may be accepted based on availability.",
    },
    {
      question: "Can someone else collect my documents?",
      answer:
        "Only the applicant or authorized representative with proper documentation can collect processed documents. A written authorization letter is required for representatives.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Comprehensive consular services for Thai citizens living in Finland
            and travelers. We provide assistance with documentation, civil
            registration, and emergency support.
          </p>
        </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-2">
                    Thai nationals facing emergencies can contact our 24/7
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="shadow-card hover:shadow-elegant transition-all duration-300 relative"
              >
                {service.badge && (
            ...
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-lg text-foreground font-medium">
                  Please make appointment before visiting the Embassy.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-background/80 p-6 rounded-lg">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Please send the document that you need to legalized and
                    Legalization form with a copy of passport to{" "}
                    <strong className="text-primary">
                      consular@tembassy.fi
                    </strong>{" "}
                    for prior approval by e-mail.
                  </p>
                ...
                <div className="bg-background/80 p-6 rounded-lg">
                  ...
                  <p className="text-muted-foreground">
                    After approval, you will get appointment to visit the
                    embassy.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-muted-foreground">
                  Need help? Use the Quick Actions section below for forms and
                  support.
                </p>
              </div>
            </CardContent>
            ...
            {emergencyContacts.map((contact, index) => (
              <Card key={index} className="shadow-card">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-primary font-mono mb-1">
                    {contact.contact}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {contact.hours}
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center space-x-2">
                      ...
                      <span className="text-muted-foreground">
                        Valid Thai ID card or passport
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <FileText className="h-4 w-4 text-primary" />
                      <span className="text-muted-foreground">
                        Finnish residence permit (if applicable)
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <FileText className="h-4 w-4 text-primary" />
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center space-x-2">
                      <FileText className="h-4 w-4 text-primary" />
                      <span className="text-muted-foreground">
                        Finnish translations (certified)
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <FileText className="h-4 w-4 text-primary" />
                      <span className="text-muted-foreground">
                        Service fees (cash or card)
                      </span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <FileText className="h-4 w-4 text-primary" />
                      <span className="text-muted-foreground">
                        Proof of Finnish address
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <section className="text-center bg-secondary/20 rounded-lg p-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Email your documents for approval or contact us for more information
