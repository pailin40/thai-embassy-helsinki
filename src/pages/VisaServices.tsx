...
const VisaServices = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description:
        "Apply 4-8 weeks before travel date. Do NOT submit more than 3 months before departure",
    },
    {
      step: 4,
      title: "Provide Genuine Documents",
      description:
        "Provide authentic documents and information. False documents will result in rejection and travel prohibition",
    },
    {
      step: 5,
      title: "Processing & Collection",
      description:
        "7 working days processing time. You'll receive email approval when visa is granted",
    },
  ];
  ...
  const faqItems = [
    {
      ...
      answer:
        "Standard processing time is 7 working days from when we receive complete documents. Processing may take longer in certain cases or during peak seasons.",
    },
    {
      question: "Can I apply if I'm not in Finland?",
      answer:
        "No, the Royal Thai Embassy Helsinki only processes visa applications when the applicant is physically present in Finland or Estonia.",
    },
    {
      question: "When should I apply for my visa?",
      answer:
        "We recommend applying 4-8 weeks before your travel date. Do not submit your application more than 3 months before your departure date.",
    },
    {
      question: "What happens if I submit false documents?",
      answer:
        "Applications with false documents or information will be rejected and reported. This may result in future prohibition from entering Thailand.",
    },
    {
      question: "How will I know when my visa is approved?",
      answer:
        "You will receive an email notification once your visa is granted. The embassy will contact you for document collection.",
    },
    {
      question: "Can the embassy reject my application?",
      answer:
        "Yes, the embassy reserves the right to reject any application without prejudice and may request additional documents or an in-person interview.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Apply for Thai visas with professional guidance. We offer
            comprehensive visa services for tourism, business, and transit
            purposes.
          </p>
        </div>
            ...
            <Card className="shadow-md hover:shadow-lg transition-shadow duration-200 cursor-pointer group">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Get application forms and checklists
                </p>
              </CardContent>
            </Card>
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://youtu.be/k85mRPqvMbE?si=Ads2mG28CNJB9Dll",
                        "_blank"
                      )
                    }
                  >
        ...
        <section className="text-center bg-secondary/20 rounded-lg p-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our consular staff is available to help with your visa application
            during office hours.
          </p>
