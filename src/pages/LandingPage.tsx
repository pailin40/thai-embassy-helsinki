  ...
  const services = [
    {
      ...
      description:
        "Tourist, business, and transit visas for travel to Thailand",
      link: "/visa-services",
    },
    {
      icon: Users,
      ...
      description:
        "Passport services, document authentication, and citizen assistance",
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Comprehensive diplomatic and consular services to support your
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card
                key={index}
                className="bg-card-gradient shadow-card hover:shadow-elegant transition-all duration-300 border-0"
              >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div>
                        ...
                        <a
                          href="mailto:idpassport@tembassy.fi"
                          className="text-primary hover:underline"
                        >
                          idpassport@tembassy.fi
                        </a>
                      </div>
                      <div>
                        <div className="font-medium text-foreground">
                        ...
                        <a
                          href="mailto:chancery@tembassy.fi"
                          className="text-primary hover:underline"
                        >
                          chancery@tembassy.fi
                        </a>
                      </div>
                    </div>
                  </CardContent>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Everything you need to know for your journey to Thailand. From
              ...
              <div className="space-y-4">
                <Card className="shadow-card hover:shadow-elegant transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Updated procedures for tourist visa applications effective
                      immediately.
                    </p>
                ...
                <Card className="shadow-card hover:shadow-elegant transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Embassy closure dates for upcoming Thai holidays.
                    </p>
                    <Button variant="link" className="p-0 h-auto text-primary">
                      Read more →
                    </Button>
                ...
                <Card className="shadow-card hover:shadow-elegant transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      New security protocols for embassy visits.
                    </p>
                    <Button variant="link" className="p-0 h-auto text-primary">
                      Read more →
                    </Button>
              ...
              <div className="space-y-4">
                <Card className="shadow-card hover:shadow-elegant transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <h5 className="font-semibold text-foreground mb-2">
                      Thai Cultural Festival 2024
                    </h5>
                    <p className="text-sm text-muted-foreground mb-3">
                      Join us for the annual Thai cultural celebration in
                      Helsinki.
                    </p>
                    <Button variant="link" className="p-0 h-auto text-primary">
                      Learn more →
                ...
                <Card className="shadow-card hover:shadow-elegant transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      Finnish-Thai business delegation strengthens bilateral
                      relations.
                    </p>
                    <Button variant="link" className="p-0 h-auto text-primary">
                      Learn more →
                ...
                <Card className="shadow-card hover:shadow-elegant transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      New opportunities for Finnish students to study in
                      Thailand.
                    </p>
                    <Button variant="link" className="p-0 h-auto text-primary">
                      Learn more →
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <Button size="lg" className="bg-accent hover:bg-accent-hover">
              Emergency Contact: +358 44 444 4444
            </Button>
          </div>
        </div>
      </section>
