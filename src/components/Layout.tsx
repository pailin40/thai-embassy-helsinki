...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Top Info Bar - compact and sticky, hide on scroll */}
      {showInfoBar && (
        <div className="bg-primary text-primary-foreground px-4 py-2 w-full z-30 sticky top-0 transition-all duration-300">
